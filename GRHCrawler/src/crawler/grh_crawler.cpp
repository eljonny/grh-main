...
void GRHCrawler::run(GRHCrawlerConfig config) {
    //Call out to each configured site by category 
    
}

GRHCrawlerSiteData GRHCrawler::data() {
    return _data;
}

void GRHCrawler::parse(GRHDocument siteData) {
    ...
    char html[] = siteData.data.rawData.c_str();
